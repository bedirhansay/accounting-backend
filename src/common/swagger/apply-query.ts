...
export function ApiPaginatedQuery() {
  return applyDecorators(
    ...
    ApiQuery({ name: 'beginDate', required: false, description: 'Başlangıç tarihi', type: String }),
    ApiQuery({ name: 'endDate', required: false, description: 'Bitiş tarihi', type: String })
  );
}
